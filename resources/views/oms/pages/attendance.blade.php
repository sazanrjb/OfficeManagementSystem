                            ...
                            <div class="form-group">
                                ...
                                <div id="checkbox">
                                    @foreach($result as $res)
                                        ...
                                        <label>{{$res->first_name}} {{$res->middle_name}} {{$res->last_name}} [User
                                            ID: {{$res->id}}]</label><br>
                                    @endforeach
                                </div>
            ...
            <div class="row center-block">
                <div class="form-group">
                    <table class="table table-striped table-responsive ">
                        ...
                        {!!Form::open(array('url'=>'/attendances/get-by-date','method'=>'post'))!!}
                        <div class="center-block text-center">

                            Choose
                            Date: {!!Form::input('text','date','',array('class'=>'datepicker','placeholder'=>'Choose date'),['disabled'=>'disabled'])!!}
            ...
            <div class="row center-block">
                ...
                <div class="form-group">
                    <table class="table table-striped table-responsive ">
                        ...
                        {!!Form::open(array('url'=>'/attendances/get-by-month-and-year','method'=>'post'))!!}
                        <div class="center-block text-center">
                            <div class="col-md-8 col-md-offset-2 well" style="max-height: 25em; overflow: auto;">
                                Choose
                                Date: {!!Form::input('text','year','',array('placeholder'=>'Year','class'=>'form-control'))!!}
                                {!!Form::select('month',['01'=>'Jan','02'=>'Feb','03'=>'Mar','04'=>'Apr','05'=>'May','06'=>'Jun','07'=>'Jul','08'=>'Aug','09'=>'Sep','10'=>'Oct','11'=>'Nov','12'=>'Dec'],null,['class'=>'form-control'])!!}
                                <br>
                                {!!Form::submit('View Attendance',array('class'=>'btn btn-primary'))!!}
                            </div>
                        </div>
