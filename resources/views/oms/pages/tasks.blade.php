                    ...
                    <div class="col-md-8 col-md-offset-2 well">
                        ...
                        <div class="form-group">
                            ...
                            @if(!empty(array($result)))
                                ...
                                {!!Form::input('text','task_name','',array('class'=>'form-control','placeholder'=>'Task Name'))!!}

                        </div>
                        <div class="form-group">
                            <label>Task Description</label>
                            {!!Form::textarea('task_description','',array('class'=>'form-control','placeholder'=>'Task Description'))!!}

                        </div>
                        <div class="form-group">
                            <label>Assigned Date</label>
                            {!!Form::text('assigned_date','',array('class'=>'form-control datepicker','placeholder'=>'Starting Date'))!!}
                        </div>
                        <div class="form-group">
                            <label>Completion Date</label>
                            {!!Form::text('completion_date','',array('class'=>'form-control datepicker','placeholder'=>'Ending Date'))!!}
                        ...
                        <div class="form-group">
                            ...
                            @foreach($result as $res)
                                <!--                        {!!Form::checkbox('emp_name[]','{{$res->id}}')!!}-->
                                    <input name="emp_name[]" type="checkbox" value="{{$res->id}}">
                                    <label>{{$res->first_name}} {{$res->middle_name}} {{$res->last_name}} [{{$res->id}}
                                        ]</label><br>
                                @endforeach
                            </div>
                        </div>
